...
| Sectors | Pick a sector and see who holds it, most exposed first, with bounds to narrow the range: every fund in IT, or only the ones under 10%. Exposure is a share of the fund's own equity book. Tick rows to carry them into Compare or the portfolio builder. |
